            ...
            <table id="facproducto">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$saleDetail->waffle->nombre}}</td>
                        <td>s/ {{$saleDetail->precio}}</td>
                        <td>{{$saleDetail->decuento}}</td>
                        <!-- <td>s/ {{number_format($saleDetail->quantity*$saleDetail->price - $saleDetail->cantidad*$saleDetail->precio*$saleDetail->descuento/100,2)}} -->
                        </td>
                    </tr>
                    @endforeach
                </tbody>
