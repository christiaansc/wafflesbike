                        ...
                        <table id="order-listing" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ($sale->stado == 'VALIDO')
                                    <td>
                                        <a class="jsgrid-button btn btn-success" href="{{route('change.status.ventas', $sale)}}" title="Editar">
                                            Activo <i class="fas fa-check"></i>
                                        </a>
                                    </td>
                                    @else
                                    <td>
                                        <a class="jsgrid-button btn btn-danger" href="{{route('change.status.ventas', $sale)}}" title="Editar">
